...
var SYSTEM_PROMPT = [
  ...
  "- Package I — Foundation and Stable Growth — 3000 GEL/month. Content strategy, neuromarketing copywriting, graphic design, Business Manager setup and management (FB, IG, LinkedIn, TikTok), video production and editing.",
  "- Package II — Aggressive Lead Generation — 4500 GEL/month (MOST POPULAR). Everything in I, plus multi-format ad creative, professional voiceover for video ads, retargeting, precise neuro-segmentation, A/B testing, and website creation. Includes 90-day results guarantee.",
  "- Package III — Market Domination — 6000 GEL/month. Everything in I and II, plus strategic sales consulting, full brand neuro-identity packaging, original brand music (sonic branding). Includes 90-day results guarantee.",
  "",
